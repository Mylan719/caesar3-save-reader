...
namespace CeasarSaveReader.File
{
    public class SaveFileReader
    {
        ...
        private GameSave savegame_load_from_state(int version)
        {
            ...
            gameSave.EdgeGrid = LoadGrid(data.state.edge_grid.Data, gameSave.Scenario.map, r => (PropertyType)r.ReadByte());
            gameSave.Elevation = LoadGrid(data.state.elevation_grid.Data, gameSave.Scenario.map, r => (int)r.ReadByte());
            gameSave.BitField = LoadGrid(data.state.bitfields_grid.Data, gameSave.Scenario.map, r => (int)r.ReadByte());
